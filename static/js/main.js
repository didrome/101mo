...
var main = {
  ...
  initImgs : function() {
    ...
    var imgInfo = main.getImgInfo(0);
    var src = imgInfo.src;
    var desc = imgInfo.desc;
    var position = imgInfo.position;
    var num_img = imgInfo.num_img;
      main.setImg(src, desc, position);

    // For better UX, prefetch the next image so that it will already be loaded when we want to show it
      var getNextImg = function(num_img) {
      var imgInfo = main.getImgInfo(num_img);
      var src = imgInfo.src;
      var desc = imgInfo.desc;
      var position = imgInfo.position;
      var num_img = imgInfo.num_img;
...
//          img.css("background-position", position);
        ...
        img.css("background-attachment", "fixed");
  ...
  getImgInfo : function(num_img) {
//    var randNum = Math.floor((Math.random() * main.numImgs) + 1);
    var randNum = num_img + 1;
    if(randNum > main.numImgs ) randNum = 1;
